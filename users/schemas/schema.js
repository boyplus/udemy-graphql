...
const CompanyType = new GraphQLObjectType({
  name: 'Company',
  // When we make fields as an arrow function that return object, it will not be executed until it is running
  // It solves the problem that UserType is not defined (closures problem)
  fields: () => ({
...
const mutation = new GraphQLObjectType({
  ...
  fields: {
    addUser: {
      // What type of record that will be returned
      type: UserType,
      args: {
    ...
    editUser: {
      ...
      resolve(parentValue, args) {
        // JSON server will ignore the id that we pass in
